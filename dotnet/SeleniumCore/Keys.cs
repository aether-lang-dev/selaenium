...
public static class Keys
{
    ...
    /// <summary>Represents the Shift key.</summary>
    public static readonly string LeftShift = Convert.ToString(Convert.ToChar(0xE008), CultureInfo.InvariantCulture)!; // alias

    /// <summary>Represents the Control key.</summary>
    public static readonly string Control = Convert.ToString(Convert.ToChar(0xE009), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the Control key.</summary>
    public static readonly string LeftControl = Convert.ToString(Convert.ToChar(0xE009), CultureInfo.InvariantCulture)!; // alias

    /// <summary>Represents the Alt key.</summary>
    public static readonly string Alt = Convert.ToString(Convert.ToChar(0xE00A), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the Alt key.</summary>
    public static readonly string LeftAlt = Convert.ToString(Convert.ToChar(0xE00A), CultureInfo.InvariantCulture)!; // alias

    /// <summary>Represents the Pause key.</summary>
    public static readonly string Pause = Convert.ToString(Convert.ToChar(0xE00B), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the Escape key.</summary>
    public static readonly string Escape = Convert.ToString(Convert.ToChar(0xE00C), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the Spacebar key.</summary>
    public static readonly string Space = Convert.ToString(Convert.ToChar(0xE00D), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the Page Up key.</summary>
    public static readonly string PageUp = Convert.ToString(Convert.ToChar(0xE00E), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the Page Down key.</summary>
    ...
    /// <summary>Represents the left arrow key.</summary>
    public static readonly string Left = Convert.ToString(Convert.ToChar(0xE012), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the left arrow key.</summary>
    public static readonly string ArrowLeft = Convert.ToString(Convert.ToChar(0xE012), CultureInfo.InvariantCulture)!; // alias

    /// <summary>Represents the up arrow key.</summary>
    public static readonly string Up = Convert.ToString(Convert.ToChar(0xE013), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the up arrow key.</summary>
    public static readonly string ArrowUp = Convert.ToString(Convert.ToChar(0xE013), CultureInfo.InvariantCulture)!; // alias

    /// <summary>Represents the right arrow key.</summary>
    public static readonly string Right = Convert.ToString(Convert.ToChar(0xE014), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the right arrow key.</summary>
    public static readonly string ArrowRight = Convert.ToString(Convert.ToChar(0xE014), CultureInfo.InvariantCulture)!; // alias

    /// <summary>Represents the down arrow key.</summary>
    public static readonly string Down = Convert.ToString(Convert.ToChar(0xE015), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the down arrow key.</summary>
    public static readonly string ArrowDown = Convert.ToString(Convert.ToChar(0xE015), CultureInfo.InvariantCulture)!; // alias

    /// <summary>Represents the Insert key.</summary>
    public static readonly string Insert = Convert.ToString(Convert.ToChar(0xE016), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the Delete key.</summary>
    public static readonly string Delete = Convert.ToString(Convert.ToChar(0xE017), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the semi-colon key.</summary>
    public static readonly string Semicolon = Convert.ToString(Convert.ToChar(0xE018), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the equal sign key.</summary>
    public static readonly string Equal = Convert.ToString(Convert.ToChar(0xE019), CultureInfo.InvariantCulture)!;

    // Number pad keys

    /// <summary>Represents the number pad 0 key.</summary>
    public static readonly string NumberPad0 = Convert.ToString(Convert.ToChar(0xE01A), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the number pad 1 key.</summary>
    public static readonly string NumberPad1 = Convert.ToString(Convert.ToChar(0xE01B), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the number pad 2 key.</summary>
    public static readonly string NumberPad2 = Convert.ToString(Convert.ToChar(0xE01C), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the number pad 3 key.</summary>
    public static readonly string NumberPad3 = Convert.ToString(Convert.ToChar(0xE01D), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the number pad 4 key.</summary>
    public static readonly string NumberPad4 = Convert.ToString(Convert.ToChar(0xE01E), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the number pad 5 key.</summary>
    public static readonly string NumberPad5 = Convert.ToString(Convert.ToChar(0xE01F), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the number pad 6 key.</summary>
    public static readonly string NumberPad6 = Convert.ToString(Convert.ToChar(0xE020), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the number pad 7 key.</summary>
    public static readonly string NumberPad7 = Convert.ToString(Convert.ToChar(0xE021), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the number pad 8 key.</summary>
    public static readonly string NumberPad8 = Convert.ToString(Convert.ToChar(0xE022), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the number pad 9 key.</summary>
    public static readonly string NumberPad9 = Convert.ToString(Convert.ToChar(0xE023), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the number pad multiplication key.</summary>
    public static readonly string Multiply = Convert.ToString(Convert.ToChar(0xE024), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the number pad addition key.</summary>
    public static readonly string Add = Convert.ToString(Convert.ToChar(0xE025), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the number pad thousands separator key.</summary>
    public static readonly string Separator = Convert.ToString(Convert.ToChar(0xE026), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the number pad subtraction key.</summary>
    public static readonly string Subtract = Convert.ToString(Convert.ToChar(0xE027), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the number pad decimal separator key.</summary>
    public static readonly string Decimal = Convert.ToString(Convert.ToChar(0xE028), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the number pad division key.</summary>
    public static readonly string Divide = Convert.ToString(Convert.ToChar(0xE029), CultureInfo.InvariantCulture)!;

    // Function keys

    /// <summary>Represents the function key F1.</summary>
    public static readonly string F1 = Convert.ToString(Convert.ToChar(0xE031), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the function key F2.</summary>
    public static readonly string F2 = Convert.ToString(Convert.ToChar(0xE032), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the function key F3.</summary>
    public static readonly string F3 = Convert.ToString(Convert.ToChar(0xE033), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the function key F4.</summary>
    public static readonly string F4 = Convert.ToString(Convert.ToChar(0xE034), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the function key F5.</summary>
    public static readonly string F5 = Convert.ToString(Convert.ToChar(0xE035), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the function key F6.</summary>
    public static readonly string F6 = Convert.ToString(Convert.ToChar(0xE036), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the function key F7.</summary>
    public static readonly string F7 = Convert.ToString(Convert.ToChar(0xE037), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the function key F8.</summary>
    public static readonly string F8 = Convert.ToString(Convert.ToChar(0xE038), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the function key F9.</summary>
    public static readonly string F9 = Convert.ToString(Convert.ToChar(0xE039), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the function key F10.</summary>
    public static readonly string F10 = Convert.ToString(Convert.ToChar(0xE03A), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the function key F11.</summary>
    public static readonly string F11 = Convert.ToString(Convert.ToChar(0xE03B), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the function key F12.</summary>
    public static readonly string F12 = Convert.ToString(Convert.ToChar(0xE03C), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the function key META.</summary>
    public static readonly string Meta = Convert.ToString(Convert.ToChar(0xE03D), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the function key COMMAND.</summary>
    public static readonly string Command = Convert.ToString(Convert.ToChar(0xE03D), CultureInfo.InvariantCulture)!;

    /// <summary>Represents the Zenkaku/Hankaku key.</summary>
    public static readonly string ZenkakuHankaku = Convert.ToString(Convert.ToChar(0xE040), CultureInfo.InvariantCulture)!;
}
