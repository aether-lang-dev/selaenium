...
const byLocatorFor = lazy('void* aether_sel_embed_by_locator_for(void* h, const char* strategy, const char* value)')
const isNative = lazy('int aether_sel_embed_is_native(void* h)')
const setNative = lazy('void aether_sel_embed_set_native(void* h, int on)')
